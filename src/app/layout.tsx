...
export const metadata: Metadata = {
  title: 'Oven BBQ Revive | Professional Oven & BBQ Cleaning Services in Surrey',
  description: 'The #1 oven cleaning service in Surrey. Professional, eco-friendly cleaning services for your oven, BBQ, and kitchen appliances. Book your cleaning service today!',
  keywords: 'oven cleaning surrey, bbq cleaning surrey, professional oven cleaning, eco-friendly cleaning service, hob cleaning, extractor hood cleaning',
  openGraph: {
    title: 'Oven BBQ Revive | Professional Oven & BBQ Cleaning Services in Surrey',
    description: 'The #1 oven cleaning service in Surrey. Professional, eco-friendly cleaning services for your oven, BBQ, and kitchen appliances.',
    url: 'https://ovenbbqrevive.co.uk',
    siteName: 'Oven BBQ Revive',
    images: [
      {
        url: '/media/pexels-rdne-8522748.jpg',
        width: 1200,
        height: 630,
        alt: 'Oven BBQ Revive - Professional Cleaning Services',
      },
    ],
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Oven BBQ Revive | Professional Oven & BBQ Cleaning Services in Surrey',
    description: 'The #1 oven cleaning service in Surrey. Professional, eco-friendly cleaning services for your oven, BBQ, and kitchen appliances.',
    images: ['/media/pexels-rdne-8522748.jpg'],
  },
  robots: {
    index: true,
    follow: true,
        ...
        <footer className="bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              <div>
                <h3 className="text-lg font-semibold mb-4 text-[#fb5a25]">Location</h3>
                <p className="text-gray-400">Surrey</p>
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4 text-[#fb5a25]">Contact</h3>
                <ul className="space-y-2">
                  <li className="text-gray-400">Phone: 07123 456789</li>
                  <li className="text-gray-400">Email: info@ovenbbqrevive.co.uk</li>
                  <li className="flex space-x-4 mt-4">
                    <a href="#" className="text-gray-400 hover:text-[#fb5a25] transition-colors">
            ...
            <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
              <p>&copy; {new Date().getFullYear()} Oven BBQ Revive. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </body>
